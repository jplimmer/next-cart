...
export const experimentalData: Product[] = [
  {
    id: '1',
  ...
  },
  {
    ...
    slug: 'productito',
    price: 10,
    description: 'estoy creando un nuevo producto',
    category: {
      id: '1',
      name: 'Clothes',
      slug: 'clothes',
  ...
  },
  {
    ...
    category: {
      ...
      slug: 'michu',
      image:
        'https://firebasestorage.googleapis.com/v0/b/platzi-store-forms.appspot.com/o/categories%2F1757612171086_Captura%20de%20pantalla%202025-03-20%20173701.png?alt=media&token=9857be0d-6cc1-4ddb-ad4f-a42baecf1a4f',
    },
    images: ['https://placeimg.com/640/480/any'],
  },
  {
    id: '54',
    title: 'Product Number 2 with image',
    slug: 'product-number-2-with-image',
    price: 120,
    description: 'This should have a thumbnail image…',
    category: {
      id: '6',
      name: 'michu',
      slug: 'michu',
  ...
  },
  {
    ...
    price: 1200,
    description:
      'Asljhflkj adflkjhldksjfhlaskhjdflkajhdslfkjhasdlkfjhaslkdjhlaskhjlfkajhdsflkjh. Fsakljh;Ashdod kjdshflaskhjdlfkjhadslfkjhlsdkfjhas',
    category: {
      id: '6',
      name: 'michu',
      slug: 'michu',
